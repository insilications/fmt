...
Version  : 7.1.3
Release  : 4
URL      : https://github.com/fmtlib/fmt/archive/7.1.3/fmt-7.1.3.tar.gz
Source0  : https://github.com/fmtlib/fmt/archive/7.1.3/fmt-7.1.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614363848
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/fmt-7.1.3/LICENSE.rst %{buildroot}/usr/share/package-licenses/fmt/a6571b819c2fb290e2bb182e92a7a20d7d42318d
cp %{_builddir}/fmt-7.1.3/doc/python-license.txt %{buildroot}/usr/share/package-licenses/fmt/f19fa3302647d3061306ffb9ef072a777c166e0b
pushd clr-build
%make_install
popd
