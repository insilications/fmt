...
Version  : 8.0.1
Release  : 206
URL      : file:///aot/build/clearlinux/packages/fmt/fmt-v8.0.1.tar.gz
Source0  : file:///aot/build/clearlinux/packages/fmt/fmt-v8.0.1.tar.gz
...
%package staticdev
Summary: staticdev components for the fmt package.
Group: Default
Requires: fmt-dev = %{version}-%{release}

%description staticdev
staticdev components for the fmt package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640455928
mkdir -p clr-build
pushd clr-build
